...
public class StudentManagement {
	...
	public void initStudents() {
		students[1] = new Student(1, "Nam1", 1);
		students[2] = new Student(2, "Long", 1);
		students[3] = new Student(3, "Nghĩa", 1);
		students[4] = new Student(4, "Chiến", 2);
		students[5] = new Student(5, "Hữu", 2);
		students[6] = new Student(6, "Tú", 2);
		students[7] = new Student(7, "Bích", 3);
		students[8] = new Student(8, "H.Chiến", 3);
